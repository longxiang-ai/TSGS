...
data_base_path='/data0/ClearPose/ClearPose/processed'
out_base_path='output_real'
eval_path='/data0/ClearPose/ClearPose/processed'
...
for scene in scenes:
    ...
    if not args.skip_metrics:
      cmd = f"CUDA_VISIBLE_DEVICES={gpu_id} python scripts/eval_clearpose/eval.py " + \
